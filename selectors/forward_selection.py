...
class ForwardFeatureSelector(FeatureSelector):
    ...
    @staticmethod
    def get_importance_cv_func(features, lgb_params, cat_cols, num_boost_round, target_col, importance_type):
        """
    ...
    @staticmethod
    def get_selection_cv_func(features, lgb_params, cat_cols, num_boost_round, target_col):
        """
        Статический метод, возвращающий функцию для groupBy("fold_id").applyInPandas,
